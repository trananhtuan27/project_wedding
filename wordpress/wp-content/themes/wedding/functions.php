...
if ( ! function_exists( 'wedding_setup' ) ) :
	...
	function wedding_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'wedding_custom_background_args',
				array(
...
function wedding_scripts() {
    ...
    wp_enqueue_style( 'wedding-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wedding-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wedding-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
